const DataModel = require("../Models/jenisusulanModels2027");
...
const getAllDatas = async (req, res) => {
  try {
    ...
    res.json({
      message: "GET all data jenis usulan 2027 success",
      data,
    });
  } catch (error) {
    res.status(500).json({
...
const createNewData = async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({
      message: "CREATE jenis usulan 2027 success",
      data: req.body,
    });
  } catch (error) {
    res.status(500).json({
...
const updateData = async (req, res) => {
  ...
  try {
    ...
    res.json({
      message: "UPDATE jenis usulan 2027 success",
      data: {
        id: idData,
        ...updatedBody,
      },
...
const deleteData = async (req, res) => {
  ...
  try {
    ...
    res.json({
      message: "DELETE jenis usulan 2027 success",
    });
  } catch (error) {
    res.status(500).json({
      message: "Server Error",
